...
<body style="background-color: grey">
	...
	<?php
			     ...
			     if(isset($_POST['noticebtn']))
				{
					...
					echo "<script>alert(' successfully sent notice to all ISY34AT students');</script>";
				}
    ...
    <div class = "navbar">
	 ...
	 <div>
	       <br><br><br>
	       <form action = "ISY34AT.php" method = "post" enctype = "multipart/form-data" >
			 ...
			 <?php
			   ...
			   $ret= mysqli_query($db,"SELECT * FROM notice WHERE subjCode ='ISY34AT'"); 
		   ...
		   $ret1= mysqli_query($db,"SELECT * FROM document WHERE subjCode ='ISY34AT'"); 
