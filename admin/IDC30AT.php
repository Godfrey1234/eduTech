...
<body style="background-color: grey">
	...
	<?php
			     ...
			     if(isset($_POST['noticebtn']))
				{
					...
					echo "<script>alert(' successfully sent notice to all IDC30AT students');</script>";
				}
    ...
    <div class = "navbar">
	 ...
	 <div>
	       <br><br><br>
	       <form action = "IDC30AT.php" method = "post" enctype = "multipart/form-data" >
			 ...
			 <?php
			   ...
			   $ret= mysqli_query($db,"SELECT * FROM notice WHERE subjCode ='IDC30AT'"); 
		   ...
		   $ret1= mysqli_query($db,"SELECT * FROM document WHERE subjCode ='IDC30AT'"); 
