...
<body style="background-color: grey">
	...
	<?php
			     ...
			     if(isset($_POST['noticebtn']))
				{
					...
					echo "<script>alert(' successfully sent notice to all TPG111T students');</script>";
				}
    ...
    <div class = "navbar">
	 ...
	 <div>
	       <br><br><br>
	       <form action = "TPG111T.php" method = "post" enctype = "multipart/form-data" >
			 ...
			 <?php
			   ...
			   $ret= mysqli_query($db,"SELECT * FROM notice WHERE subjCode ='TPG111T'"); 
		     ...
		     if(isset($_POST['del']))
				{
				   ...
				   if($ret){
					...
					{
						echo "<script>alert('paste notice correctly without its numbering eg 1.,2.3. ');</script>";
					}					
		   ...
		   $ret1= mysqli_query($db,"SELECT * FROM document WHERE subjCode ='TPG111T'"); 
