...
<body style="background-color: grey">
    ...
    <div class = "navbar">
	 ...
	 <div>
	  ...
	  <form action = "SSF24AT.php" method = "post" enctype = "multipart/form-data" >
	 ...
	 <div>
	       <?php
			   ...
			   $ret= mysqli_query($db,"SELECT * FROM notice WHERE subjCode ='SSF24AT'"); 
		   ...
		   $ret1= mysqli_query($db,"SELECT * FROM document WHERE subjCode ='SSF24AT'"); 
